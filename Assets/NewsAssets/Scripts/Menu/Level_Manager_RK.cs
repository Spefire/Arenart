...
public class Level_Manager_RK: MonoBehaviour {
    ...
    void Update() {
		if (SceneManager.GetActiveScene ().name == "Scene_Principale") {
			select_P1 = Selection_Perso1_RK.select_perso;
			select_P2 = Selection_Perso2_RK.select_perso;
		} else if (!started) {
			print ("Scene en cours : " + SceneManager.GetActiveScene ().name);
			started = true;
